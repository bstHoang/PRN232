...
namespace givenAPI.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public ActionResult<List<MovieResponse>> GetMovies()
        {
            ...
            var movieProducer = DataInitializer.Producers;
            ...
            List<MovieResponse> result = movies
                .Select(m =>
                {
                    ...
                    var producer = movieProducer.FirstOrDefault(predicate => predicate.Id == m.ProducerId);
                    ...
                    return new MovieResponse
                    {
                        ...
                        Genres = movieGenres
                            ...
                            .ToList(),
                        Producer = producer is null ? null : new MovieResponse.ProducerInfo
                        {
                            Id = producer.Id,
                            Name = producer.Name
                        }
